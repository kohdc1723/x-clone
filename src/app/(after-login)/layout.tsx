...
import NavMenu from "@/app/(after-login)/_components/nav-menu";
import LogoutButton from "@/app/(after-login)/_components/logout-button";
import TrendSection from "./_components/trend-section";
import FollowRecommend from "./_components/follow-recommend";
import RightSearchZone from "./_components/right-search-zone";
